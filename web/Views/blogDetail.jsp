    ...
    <body>
            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-7 pb-5">
                    ...
                    <div class="d-flex mb-3">
                        <small class="pt-1">Date Created: ${blog.date_create_by}</small>
                    </div>
                    <p class="mb-4">${blog.description}</p>
                    <div class="d-flex pt-2">
                        <p class="text-dark font-weight-medium mb-0 mr-2">Share on: ${blog.user.username}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid py-5">
            <div class="text-center mb-4">
                <h2 class="section-title px-5"><span class="px-2">Post Related</span></h2>
            </div>
            <div class="row px-xl-5">
                <div class="col">
