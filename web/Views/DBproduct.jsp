<%-- 
    Document   : DBproduct
    Created on : Jul 2, 2024, 3:09:11 PM
    Author     : admin
--%>
...
int displayYear = (yearParam != null && !yearParam.isEmpty()) ? Integer.parseInt(yearParam) : currentYear;
        ...
        <script>
            ...
            <c:forEach items="${cus}" var="entry">
            date.push('${entry.key}');
            cus.push(<c:out value="${entry.value}"/>);
            </c:forEach>
            document.addEventListener('DOMContentLoaded', function () {
                const lineChartOptions = {
                    ...
                    title: {
                        text: 'Sản phẩm mới theo từng ngày',
                        align: 'left'
                    },
                    grid: {
                        row: {
