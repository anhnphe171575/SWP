            ...
            <jsp:include page="SidebarUser.jsp"></jsp:include>
                <div class="main-content">
                    <div class="container profile-container">
                        <form id="sliderForm" action="editProfileCustomerURL" method="post" enctype="multipart/form-data" onsubmit="return validatePhoneNumber()">
                        <% 
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label>ID</label>
                                        <input type="text" class="form-control" name="customerID" value="<%=obj.getCustomerID()%>" readonly>
                                    </div>
                                    <div class="col-md-6 form-group">
                                ...
                                <div class="form-group" >
                                    ...
                                    <input type="text" class="form-control" name="securityAnswer" value="<%=obj.getSecutityAnswer()%>" readonly id="security-answer" style="display: none;">
                        ...
                        success: function (response) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = 'editProfileCustomerURL';
                                }
                            });
                        },
                        error: function () {
