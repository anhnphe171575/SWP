...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="col-sm-7">
                                ...
                                <form action="CustomerServletURL" method="get">
                                    <p>
                                        ...
                                        Search phone: <input type="text" name="phone">
        ...
        <div id="Sort" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="CustomerServletURL" method="post" enctype="multipart/form-data">
                        <div class="modal-header">						
                        ...
                        <div class="modal-body">					
                            <div class="form-group">
                                ...
                                <select id="category-select" class="form-control" name="sort">                                   
                                    <option value="c.first_name">Name</option>
